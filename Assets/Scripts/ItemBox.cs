...
public class ItemBox : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        Player2ItemManager player2ItemManagerInContact = other.GetComponent<Player2ItemManager>();
        if (player2ItemManagerInContact != null)
        {
            player2ItemManagerInContact.GenerateItem();
            StartCoroutine(Respawn());
        }
    }
